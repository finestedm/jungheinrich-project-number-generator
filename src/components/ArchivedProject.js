...
export default function ArchivedProject(props) {
    const { setPostToEdit, toggleModalVisible, post, minimalMode } = props
    ...
    return (
        <tr>
            ...
            {!minimalMode && <td className='d-none d-md-table-cell align-middle'>
            ...
            {!minimalMode && <td className="align-middle"><FiEdit3 size='1.5em' onClick={() => toggleModalVisible(post._id)} className='m-0 project-edit-icon' /></td>}
        </tr>
    )
